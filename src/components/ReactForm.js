    ...
    <div className="App">
      ...
      {isLoading && <div>
        ...
        {(!isLoading && user) && <form encType='multipart/form-data' novalidate className="validated-form">
          ...
          {isAvailable && <a href={`https://react-form-ten-steel.vercel.app/edit/${id}`} rel="noopener noreferrer"><button onClick={(e) => {e.preventDefault()}} className="btn btn-success btn-lg m-3">Edit My Profile</button></a>}
        </form> }
        {(!isLoading && !user) && <div>
