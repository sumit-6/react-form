...
const CreateAccountPage = () => {
    ...
    return (
        <>
            ...
            <div className="form-group">
            <label htmlFor="exampleInputPassword2" className="form-label">Repeat Your Password:</label>
            <input type="password" 
                className="form-control" 
            ...
            <button onClick={e => createAccount(e)} className="btn btn-primary">Register</button>
            </form>
